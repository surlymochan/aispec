...
- **当前发布版本**：见 **[spec/README.md](spec/README.md)**（版本号与总览）、**[spec/CONVENTIONS.md](spec/CONVENTIONS.md)**（通用约定汇总）。
- **历史迭代**：见各版本合并记录（若本仓库含 iteration/ 则可查看各 SP；公开发布版以本文件与 spec 为准）。

本文件为根级入口，不重复内容；执行时以 **aispec/spec（CONVENTIONS）** 为准。
